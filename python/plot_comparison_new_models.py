...
for run_id, run_info in metadata.items():
    ...
    # side_dead_layer = run_info["properties"]["side_dead_layer"]
    # front_dead_layer = run_info["properties"]["front_dead_layer"]
    # front_space = run_info["properties"]["front_space"]
...
# fig, ax = plt.subplots(figsize=(100/inch_to_mm,80/inch_to_mm))
# for run_id, run_info in metadata.items():
#     x = run_info["properties"]["side_dead_layer"] / run_info["properties"]["front_space"]
#     y = run_info["chi_squared"]
#     ax.errorbar(x, y, None, ls="", capsize=3, marker=".", color=color(0))
# ax.set_xlabel("XXX (YYY)")
# ax.set_ylabel("Chi-squared")
# ax.set_yscale("log")
# plt.tight_layout(pad = 0.2)
...
ax.errorbar(best_sim_eff_E, best_sim_eff, best_sim_eff_unc, ls="", capsize=3, marker=".", label="best simulaion")
ax.set_xlabel("Energy (keV)")
ax.set_ylabel("Efficiency")
ax.legend(frameon=False)
plt.tight_layout(pad = 1)
...
ax.errorbar(best_sim_compare_E, best_sim_compare, best_sim_compare_unc, ls="", capsize=3, marker=".", label="best simulaion")
ax.set_xlabel("Energy (keV)")
ax.set_ylabel("Relative difference")
ax.legend(frameon=False)
plt.tight_layout(pad = 0.2)
